...
public class ParamManager implements Cloneable {
	...
	public ParamManager(HashMap<Integer, DFValue> input, HashMap<String, String> tags, String actionName, HashMap<String, DFValue> localStorage, HashMap<String, Object> specifics){
		this.input = input;
		this.tags = tags;
	...
	public ParamManager clone() {
		return new ParamManager(input, tags, actionName, localStorage, specifics);
	}
}