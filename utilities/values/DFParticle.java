...
public class DFParticle {
	...
	public Double motionVariation;
	public Double colorVariation;
	public int amount;
	...
	public Object getData(){
		return switch (getParticle()) {
			case REDSTONE -> new Particle.DustOptions(color, (float) size);
			case BLOCK_CRACK, BLOCK_DUST, BLOCK_MARKER, FALLING_DUST -> material.createBlockData();
			case ITEM_CRACK -> new ItemStack(material);
			default -> null;
		};
	}
