...
public class DFUtilities {
	...
	public static long getWait(Object[] inputArray){
		...
		switch(tags.get("Time Unit")){
			case "Ticks": return args.get("wait").getInt() * 50L;
			case "Seconds": return (long) (double) args.get("wait").getVal() * 1000L;
			case "Minutes": return (long) (double) args.get("wait").getVal() * 60000L;
		}
