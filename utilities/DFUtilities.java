...
import me.wonk2.utilities.actions.IfEntity;
...
public abstract class DFUtilities {
	public static HashMap<Material, EntityType> mobTypes = new HashMap<>() {{
	...
	public static HashMap<Material, EntityType> projTypes = new HashMap<>() {{}};
	public static HashMap<Material, EntityType> vehicleTypes = new HashMap<>() {{
	...
	public static HashMap<Material, EntityType> entityTypes = new HashMap<>();
	
	static {
		entityTypes.putAll(mobTypes);
		entityTypes.putAll(projTypes);
	}
	...
	public static Conditional getConditional(String subAction, boolean inverted, ParamManager paramManager, HashMap<String, DFValue> localStorage, HashMap<String, Object> specifics, HashMap<String, Entity[]> targetMap, Entity p){
		...
		return switch (condClass) {
			...
			case "IFENTITY" -> new IfEntity("selection", targetMap, paramManager, subAction, inverted);
	 ...
	 * @author Some guy on stack overflow xd
	 * @return Color Object from String hex
	 */
