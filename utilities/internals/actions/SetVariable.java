...
public class SetVariable {
    public static void actions(HashMap<String, DFValue> args, HashMap<String, String> tags, String action, LivingEntity target, LivingEntity[] targets, HashMap<String, DFValue> localStorage){
        switch(action){
