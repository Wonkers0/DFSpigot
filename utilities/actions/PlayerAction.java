...
public class PlayerAction extends Action {
	...
	public PlayerAction(String targetName, HashMap<String, LivingEntity> targetMap, Object[] inputArray, String action) {
	...
	private static void drawParticleCircle(Player player, DFParticle particle, Location loc, double diameter){
		...
		Bukkit.broadcastMessage(DFUtilities.parseTxt(new DFValue(dir, DFType.VEC)) + " | " + DFUtilities.parseTxt(new DFValue(DFUtilities.getBinormal(dir), DFType.VEC)) + " | " + DFUtilities.parseTxt(new DFValue(DFUtilities.getTangent(dir), DFType.VEC)));
