...
public abstract class Conditional extends Action{
	...
	public Conditional(String targetName, HashMap<String, LivingEntity> targetMap, ParamManager paramManager, String action, boolean inverted){
		super(targetName, targetMap, paramManager, action);
		this.inverted = inverted;
	}
	
	public Conditional(String targetName, HashMap<String, LivingEntity> targetMap, ParamManager paramManager, String action, HashMap<String, DFValue> localStorage, boolean inverted){
