...
public class IfVariable extends Conditional {
	...
	public boolean evaluateCondition(){
		...
		this.targets = DFUtilities.getTargets(targetName, targetMap);
			...
			switch(action){
				...
				case "=": {
					...
					for(DFValue check : checks){
						if(check.type == DFType.LOC) Bukkit.broadcastMessage(DFUtilities.locToString((Location) value.getVal()) + " | " + DFUtilities.locToString((Location) check.getVal()));
