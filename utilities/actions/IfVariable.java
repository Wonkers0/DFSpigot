		...
		switch(action){
			...
			case "=": {
				...
				for(DFValue check : checks){
					...
					Bukkit.broadcastMessage(check.getVal() + " | " + check.type);
					Bukkit.broadcastMessage(value.getVal() + " | " + value.type);
					Bukkit.broadcastMessage(String.valueOf(value.getVal() == check.getVal()));
				}
