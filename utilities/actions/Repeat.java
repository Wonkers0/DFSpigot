...
public class Repeat extends Conditional {
	...
	double id;
	double threadID;
	public Repeat(String targetName, HashMap<String, LivingEntity> targetMap, Object[] inputArray, String action, HashMap<String, DFValue> localStorage, double id, double threadID) {
