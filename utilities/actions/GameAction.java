...
public class GameAction extends Action {
	LivingEntity target;
	Object[] inputArray;
	public GameAction(String targetName, HashMap<String, LivingEntity> targetMap, Object[] inputArray, String action) {
	...
	public void invokeAction() {
		...
		switch (action) {
				case "SpawnMob": {
					...
					Bukkit.broadcastMessage(DFUtilities.lastEntity.getName());
					break;
				}
